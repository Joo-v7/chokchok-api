...
import com.chokchok.chokchokapi.product.dto.response.ProductRegisterResponseDto;
...
public class ProductService {
     ...
     */
    @Transactional
    public ProductRegisterResponseDto register(ProductRegisterRequestDto requestDto) {
            // Product
        ...
        ProductInventory savedProductInventory = productInventoryService.register(savedProduct, requestDto.quantity());

        return ProductRegisterResponseDto.from(savedProduct, savedProductInventory);
    }
